...
@include('sweet::alert')
    <div class="container">
        ...
        <div class="card-body"> <a class="btn btn-outline-warning" href="{{ route('kategoris.create') }}"><i class="fa fa-plus-square">&nbsp</i>Add Data</a>
              ...
              <thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="{{ route('kategoris.edit',$data->id) }}" class="btn btn-outline-primary"><i class="fa fa-pencil-square-o">&nbsp</i>Edit</a>
                        </td>
